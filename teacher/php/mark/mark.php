...
<?php
	...
	function insertEmployee($params) {
		 ...
		 extract($params);
		   ...
		   $sql = "INSERT INTO `school`.`add_marks` (`ID`, `mdate`, `testtype`, `tname`, `rno`, `sname`, `subname`, `marks`, `totmark`) VALUES (NULL, '$mdate', '$testtype', '$tname', '$rno', '$sname', '$subname', '$marks', '$totmark')";
	...
	function getRecords($params) {
		...
		if( !empty($params['searchPhrase']) ) {   
			...
			$where .=" OR mdate LIKE '".$params['searchPhrase']."%'";
			$where .=" OR testtype LIKE '".$params['searchPhrase']."%'";
			...
			$where .=" OR totmark LIKE '".$params['searchPhrase']."%'"; 
...
if(empty($data)){
  $data=array();
	...
	function updateEmployee($params) {
		...
		$sql = "UPDATE `add_marks` SET `mdate` = '" . $params["mdate"]."',`testtype` = '" . $params["testtype"]."',`tname` = '" . $params["tname"]."',`rno` = '" . $params["rno"]."',`sname` = '" . $params["sname"]."',`subname` = '" . $params["subname"]."',`marks` = '" . $params["marks"]."',`totmark` = '" . $params["totmark"]."' WHERE ID='".$params["edit_ID"]."'";
	...
	function deleteEmployee($params) {
		...
		$data = array();
		//print_R($_POST);die;
		$sql = "delete from `add_marks` WHERE ID='".$params["id"]."'";
