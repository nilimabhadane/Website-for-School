...
<?php
	...
	function insertEmployee($params) {
		 ...
		 extract($params);
		   ...
		   $sql = "insert into user (`ID`,`user_name`,`email`,`password`,`utype`) values(NULL,'$uname','$email','$pass','$utype')";
	...
	function getRecords($params) {
		...
		if( !empty($params['searchPhrase']) ) {   
			...
			$where .=" OR utype LIKE '".$params['searchPhrase']."%' )";
	   }
...
if(empty($data)){
  $data=array();
	...
	function updateEmployee($params) {
		...
		$sql = "UPDATE `user` SET `user_name` = '" . $params["uname"]."',
		`email` = '" . $params["email"]."',`password` = '" . $params["pass"]."',`utype` = '" . $params["utype"]."' 
