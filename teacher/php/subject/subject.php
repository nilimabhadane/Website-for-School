...
<?php
	...
	function insertEmployee($params) {
		 ...
		 extract($params);
		   ...
		   $sql = "insert into add_subject (`ID`,`subname`) values(NULL,'$subname')";
...
if(empty($data)){
  $data=array();
	...
	function updateEmployee($params) {
		...
		$sql = "UPDATE `add_subject` SET `subname` = '" . $params["subname"]."' 
	...
	function deleteEmployee($params) {
		...
		$data = array();
		//print_R($_POST);die;
		$sql = "delete from `add_subject` WHERE ID='".$params["id"]."'";
