       ...
       <div class="content">
		<div class="page-header-title">
		 ...
		 <div class="page-content-wrapper ">
			...
			<span class="glyphicon glyphicon-plus"></span> Add Event</button>
		...
		<table id="employee_grid" class="table table-bordered table-hover" width="60%" cellspacing="0" data-toggle="bootgrid">
			...
			<thead>
				<tr>
					...
					<th data-column-id="edate">Date Name</th>
					<!--th data-column-id="image" data-formatter="image" data-sortable="false">Photo</th-->
				    <th data-column-id="ename" >Event Name</th>
				    <th data-column-id="edesc" >Description</th>
    ...
    <div class="modal-dialog modal-md zoomIn  animated">
      ...
      <div class="row">
        ...
        <!--div class="col-md-12">
         ...
         <div class="col-md-12">
                 <div class="form-group">
                    <label for="user_name" class="control-label">Event Name</label>
                    <input type="text" class="form-control"  name="ename" required />
                  </div>
        </div>
        <div class="col-md-12">
                 <div class="form-group">
                    <label for="user_name" class="control-label">Description</label>
...
console.log(g_id);
  ...
  $("#user_edit").load("php/event/event_edit.php?id="+idd);       
    ...
    }).end().find(".command-delete").on("click", function(e)
    {
		...
		var conf = confirm('Delete ' + $(this).data("row-id") + ' items?');
					//alert(conf);
                    if(conf){
                                $.post('php/event/event.php', { id: $(this).data("row-id"), action:'delete'}
                                    , function(){
