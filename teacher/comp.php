       ...
       <div class="content">
		<div class="page-header-title">
		 ...
		 <div class="page-content-wrapper ">
			...
			<span class="glyphicon glyphicon-plus"></span> Add Complaints</button>
		...
		<table id="employee_grid" class="table table-bordered table-hover" width="60%" cellspacing="0" data-toggle="bootgrid">
			...
			<thead>
				<tr>
					...
					<th data-column-id="cdate">Date</th>
            ...
            <th data-column-id="divsn" >Division</th>
            <th data-column-id="cont" >Contact</th>
            <th data-column-id="cdescr" >Complaint</th>
...
<?php } ?>
         ...
         <div class="col-md-6">
				...
				<div class="col-md-6">
                 <div class="form-group">
                    <label for="user_name" class="control-label">Standard</label>
          ...
          <div class="col-md-6">
                 <div class="form-group">
                    <label for="user_name" class="control-label">Division</label>
                    <select  name="divsn" class="form-control">
                    <option>A</option>
                    <option>B</option>
                    <option>C</option>
                    <option>D</option>
        ...
        <div class="col-md-6">
                 <div class="form-group">
                    <label for="user_name" class="control-label">Complaint</label>
                    <input type="text" class="form-control"  name="cdescr" required />
                  </div>
        </div>
...
console.log(g_id);
  ...
  $("#user_edit").load("php/comp/comp_edit.php?id="+idd);       
    ...
    }).end().find(".command-delete").on("click", function(e)
    {
		...
		var conf = confirm('Delete ' + $(this).data("row-id") + ' items?');
					//alert(conf);
                    if(conf){
                                $.post('php/comp/comp.php', { id: $(this).data("row-id"), action:'delete'}
                                    , function(){
