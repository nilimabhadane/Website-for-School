...
<div class="content-page">
 ...
 <div class="row">
       ...
       <div class="col-sm-6 col-lg-3 zoomIn  animated">
		   ...
		   <div class="panel-heading">
		     <h4 class="panel-title text-muted font-light">Complaints</h4>
		   </div>

		  <div class="panel-body p-t-10"><h2 class="m-t-0 m-b-15"><i class="mdi mdi-account-circle text-danger m-r-10"></i><b><span class='count_adv'>0</span></b></h2><p class="text-muted m-b-0 m-t-20">Total Complaints</p>
		  </div>
      ...
      <!--div class="col-sm-6 col-lg-3 zoomIn  animated">
		   ...
		   <div class="panel-body p-t-10"><h2 class="m-t-0 m-b-15"><i class="mdi mdi-account-circle text-danger m-r-10"></i><b><span class='count_adv'>0</span></b></h2><p class="text-muted m-b-0 m-t-20"> Total Student </p>
		  </div>
