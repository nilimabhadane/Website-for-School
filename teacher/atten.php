    ...
    <div class="modal-dialog modal-md zoomIn  animated">
      ...
      <div class="row">
        ...
        <!--div class="col-md-12">
         ...
         <div class="col-md-6">
                 <div class="form-group">
                    <label for="user_name" class="control-label">Month</label>
...
<?php } ?>
        ...
        <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <select  name="rno" class="form-control" id="group_id">
...
<?php } ?>
         ...
         <div class="col-md-6">
				...
				<div class="col-md-6">
                 <div class="form-group">
                    <label for="user_name" class="control-label">No of Day Present</label>
                    <input type="text" class="form-control"  name="nofp" required />
                  </div>
        </div>
          <div class="col-md-6">
                 <div class="form-group">
                    <label for="user_name" class="control-label">No of Day Abscent</label>
                    <input type="text" class="form-control"  name="nofa" required />
                  </div>
        </div>
          <div class="col-md-6">
                 <div class="form-group">
                    <label for="user_name" class="control-label">No of Day Holiday</label>
...
console.log(g_id);
  ...
  $("#user_edit").load("php/atten/atten_edit.php?id="+idd);       
    ...
    }).end().find(".command-delete").on("click", function(e)
    {
		...
		var conf = confirm('Delete ' + $(this).data("row-id") + ' items?');
					//alert(conf);
                    if(conf){
                                $.post('php/atten/atten.php', { id: $(this).data("row-id"), action:'delete'}
                                    , function(){
