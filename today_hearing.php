...
$conn =  $db->getConnstring();
 ...
 $date=date('Y-m-d');
 $result=mysqli_query($conn,"select *,(select victem_name from case_master where ID=hearing_master.case_no) as victem_name,(select judge_name from case_master where ID=hearing_master.case_no) as judge_name from hearing_master where `date`='$date'");
		...
		<div id="site-content">
			...
			<main class="main-content">
				...
				<div class="fullwidth-block content">
					<div class="container">
						<h2 class="entry-title">Today Hearing</h2>
...
?>
						...
						<a href="details.php?case_no=<?php echo $rows['case_no']; ?>">		
								...
								<p style="color:white;">Judge Name : <?php echo $rows['judge_name']; ?></p>
