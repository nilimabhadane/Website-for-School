      ...
      <div class="row">
         <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input value="<?php echo $rows['edate'] ?>" type="text" class="form-control"  name="edate"/>
                  </div>
        </div>
         <div class="col-md-12">
                  <div class="form-group">
                    <label for="name" class="control-label">Event Name:</label>
                    <input value="<?php echo $rows['ename'] ?>" type="text" class="form-control"  name="ename"/>
                  </div>
        </div>
        <div class="col-md-12">
                  <div class="form-group">
                    <label for="name" class="control-label">Description:</label>
                    <input value="<?php echo $rows['edesc'] ?>" type="text" class="form-control"  name="edesc"/>
                  </div>
        </div>
