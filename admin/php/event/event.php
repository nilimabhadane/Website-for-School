...
<?php
	...
	function insertEmployee($params) {
		 ...
		 extract($params);
		   ...
		   $sql = "insert into add_event (`ID`,`edate`,`ename`,`edesc`) values(NULL,'$edate','$ename','$edesc')";
	...
	function getRecords($params) {
		...
		if( !empty($params['searchPhrase']) ) {   
			...
			$where .=" OR edate LIKE '".$params['searchPhrase']."%'";
			$where .=" OR ename LIKE '".$params['searchPhrase']."%'";
			$where .=" OR edesc LIKE '".$params['searchPhrase']."%'";
...
if(empty($data)){
  $data=array();
	...
	function updateEmployee($params) {
		...
		$sql = "UPDATE `add_event` SET `edate` = '" . $params["edate"]."',`ename` = '" . $params["ename"]."',`edesc` = '" . $params["edesc"]."' 
	...
	function deleteEmployee($params) {
		...
		$data = array();
		//print_R($_POST);die;
		$sql = "delete from `add_event` WHERE ID='".$params["id"]."'";
