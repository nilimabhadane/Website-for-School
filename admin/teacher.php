       ...
       <div class="content">
		<div class="page-header-title">
		 ...
		 <div class="page-content-wrapper ">
			...
			<span class="glyphicon glyphicon-plus"></span> Add Teacher</button>
			...
			<thead>
				<tr>
				    ...
				    <th data-column-id="cont" >Contact</th>
					  <th data-column-id="quali">Qualification</th>
            <th data-column-id="spec" >Specialization</th> 
    ...
    <div class="modal-dialog modal-md zoomIn  animated">
      ...
      <div class="row">
        ...
        <!--div class="col-md-12">
         ...
         <div class="col-md-6">
                 <div class="form-group">
                    <label for="user_name" class="control-label">Address</label>
                    <input type="text" class="form-control"  name="addr" required />
                  </div>
        </div>
        <div class="col-md-6">
                 <div class="form-group">
                    <label for="user_name" class="control-label">City</label>
                    <input type="text" class="form-control"  name="city" required />
                  </div>
        </div>
        <div class="col-md-6">
                 <div class="form-group">
                    <label for="user_name" class="control-label">Contact</label>
                    <input type="text" class="form-control"  name="cont" required />
                  </div>
        </div>
        <div class="col-md-6">
                 <div class="form-group">
                    <label for="user_name" class="control-label">Qualification</label>
                    <input type="text" class="form-control"  name="quali" required />
                  </div>
        </div>
        <div class="col-md-6">
                 <div class="form-group">
                    <label for="user_name" class="control-label">Specialization</label>
        ...
        <div class="col-md-6">
                 <div class="form-group">
                  ...
                  $resu=mysqli_query($conn,"select * from add_subject");
...
console.log(g_id);
  ...
  $("#user_edit").load("php/teacher/teacher_edit.php?id="+idd);       
    ...
    }).end().find(".command-delete").on("click", function(e)
    {
		...
		var conf = confirm('Delete ' + $(this).data("row-id") + ' items?');
					//alert(conf);
                    if(conf){
                                $.post('php/teacher/teacher.php', { id: $(this).data("row-id"), action:'delete'}
                                    , function(){
