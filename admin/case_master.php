       ...
       <div class="content">
		<div class="page-header-title">
		 ...
		 <div class="page-content-wrapper ">
			...
			<span class="glyphicon glyphicon-plus"></span> Add Case</button>
		...
		<table id="employee_grid" class="table table-bordered table-hover" width="60%" cellspacing="0" data-toggle="bootgrid">
			...
			<thead>
				<tr>
					...
					<th data-column-id="court_name">Court Name</th>
				  <th data-column-id="complaint">Complaint</th>
					
					<th data-column-id="victem_name">Victem Name</th>
					<th data-column-id="fir_no"> FIR NO </th>
					<th data-column-id="fir_date"> FIR Date   </th>
          <th data-column-id="police_station_name"> Polic Station Name </th>

          <th data-column-id="case_details">case_details</th>
          <th data-column-id="investigation_officer"> Investigation Officer Name </th>
          <th data-column-id="post"> Post   </th>
          <th data-column-id="judge_name"> Judge Name </th>

           <th data-column-id="govt_adv_name">Govt Advocate</th>
          <th data-column-id="victem_adv_name"> Victem Advocate </th>
          <th data-column-id="vitness1"> Vitness 1   </th>
          <th data-column-id="vitness2"> Vitness 2 </th>
...
<div id="add_model" class="modal fade">
    <div class="modal-dialog modal-lg zoomIn  animated">
        <div class="modal-content">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="victem_name" required />
                  </div>
				 </div>
          ...
          <div class="form-group">
                    ...
                    <input type="date" class="form-control"  name="fir_date"/>
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="police_station_name" required />
                  </div>
               </div>
  ...
  <div class="col-md-6">
   <div class="form-group">
             ...
             <input type="text" class="form-control"  name="case_details" required />
           </div>
   </div>      
...
console.log(g_id);
  ...
  $("#user_edit").load("php/case/case_master_edit.php?id="+idd);       
    ...
    }).end().find(".command-delete").on("click", function(e)
    {
		...
		var conf = confirm('Delete ' + $(this).data("row-id") + ' items?');
					//alert(conf);
                    if(conf){
                                $.post('php/case/case_master.php', { id: $(this).data("row-id"), action:'delete'}
                                    , function(){
