...
<!-- services -->
	<div class="services two">
		<div class="container">
			<h3 class="w3l_header w3_agileits_header">Atten<span>dance</span></h3>
			<center>
							<form action="comp.php" method="post">
								...
								<table width="80%" class="tbl1">
									...
									if(isset($_POST['submit']))
									{
										...
										$qry=mysqli_query($conn,"select * from add_comp where std='$std' and rno=$rno and divsn='$divsn' ");
										while ($res = mysqli_fetch_array($qry)) 
										{
											echo "<tr>";
											echo "<td>".$res['tname']."</td>";
											echo "<td>".$res['sname']."</td>";
											echo "<td>".$res['cdescr']."</td>";
